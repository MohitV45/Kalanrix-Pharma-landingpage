...
export default function AboutSection() {
  return (
    <section id="about-us" className="py-32 bg-white relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-start group/about">
          ...
          <div className="space-y-8">
            ...
            {/* Vision */}
            <div className="reveal reveal-right reveal-stagger-1">
            ...
            {/* Mission */}
            <div className="reveal reveal-right reveal-stagger-2">
              <div className="group bg-slate-200/80 p-6 rounded-2xl border border-slate-300 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex gap-4 transition-all duration-500 will-change-transform will-change-filter
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-950 mb-2">Our Mission</h3>
                  <p className="text-slate-700 leading-relaxed">
            ...
            {/* Values */}
            <div className="reveal reveal-right reveal-stagger-3">
              <div className="group bg-orange-100/80 p-6 rounded-2xl border border-orange-200 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex gap-4 transition-all duration-500 will-change-transform will-change-filter
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-950 mb-2">Our Values</h3>
                  <p className="text-slate-700 leading-relaxed">
